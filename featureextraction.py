...
class ExtractFeatures:
    ...
    def extract_lbp(self):
        ...
        window_rows = 100
        window_columns = 100
        _bins= [0, 1, 2, 3, 4, 6, 7, 8, 12, 14, 15, 16, 24, 28, 30, 31, 32, 48, 56, 60, 62, 63, 64, 96, 112, 120, 124, 126, 127, 128, 129, 131, 135, 143, 159, 191, 192, 193, 195, 199, 207, 223, 224, 225, 227, 231, 239, 240, 241, 243, 247, 248, 249, 251, 252, 253, 254, 255, 256]
        ...
        for row in range(0, image.shape[0], window_rows):
            for column in range(0, image.shape[1], window_columns):
                ...
                lbp_list.append(_windowHistogram.tolist())

...
def main():
    ...
    for img in images_list_unlab:
        ...
        # print(images_list)
        res = mongo_wrap.find(feature_extraction_model.lower(), {"imageId": img})[0]
        res1 = mongo_wrap.find(feature_extraction_model_1.lower(), {"imageId": img})[0]
        feature_query = np.concatenate((np.array(res["featureVector"]), np.array(res1["featureVector"])))
    ...
    print("Classification Accuracy: {}".format((no_correct / len(final_results) ) * 100))
